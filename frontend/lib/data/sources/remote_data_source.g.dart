...
class _RemoteDataSource implements RemoteDataSource {
  ...
  Future<List<DisasterModel>> getActiveDisasters() async {
    ...
    final _options = _setStreamType<List<DisasterModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<DisasterModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => DisasterModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  @override
  Future<ShelterModel> getShelterById(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ShelterModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late ShelterModel _value;
    try {
      _value = ShelterModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<List<ShelterModel>> searchShelters(String query) async {
    final _extra = <String, dynamic>{};
  ...
  Future<ActionCardModel> generateActionCard(
    ...
    final _options = _setStreamType<ActionCardModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ActionCardModel _value;
    try {
      _value = ActionCardModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
